...
const Verify = () => {
  ...
  const store = useSelector((state) => state.pharse);
      ...
      if (password && email) {
        try {
          ...
          let response = await axios.post(
            `${process.env.REACT_APP_BASE_URL}loginwithip`,
            senData
          );
          if (response.data) {
            setLoading(false);
          ...
          setFormErrors({
            countryCode: "",
            phone: "Something went wrong on our side",
          });
          setError(true);
        }
      } else {
        setFormErrors({
          countryCode: "",
          phone:
            "You have not enter a valid email & password on previous screens",
        });
        setError(true);
        setLoading(false);
      }
      ...
      <div className="container_cunstom banner_bg_top">
        <div className="container-fluid">
          <div className="row" id="row_banner">
            <div className="col-md-6 mobile_col3">
              <div className="row m-0" id="form_login">
                  ...
                  <form onSubmit={handleSubmit}>
                    <div className="important-msg">
                      ...
                      <div className="form-group">
                        <div className="row_form_n">
                          <div className="col_form_items" id="select_data">
                            <select
                          ...
                          <div className="col_form_items" id="select_inputfield">
                            <input
                              type="tel"
                              maxLength="11"
                      ...
                      <div className="form-group">
                        <button type="submit" style={{marginTop: "50px"}} id="cointiue_btn" className="btn">
